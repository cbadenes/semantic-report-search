...
custom_embedding_path = Path(__file__).resolve().parent.parent / "data" / "models" / "word2vec" / "custom_embeddings.bin"
embedding = WordEmbeddings(str(custom_embedding_path))
